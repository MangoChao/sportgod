define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'line/service/index',
                    add_url: 'line/service/add',
                    edit_url: 'line/service/edit',
                    del_url: 'line/service/del',
                    table: 'service',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'nickname', title: __('暱稱'), sortable: true},
                        {field: 'contact', title: __('聯繫方式'), sortable: true},
                        // {field: 'starttime', title: __('開始時間'), formatter: Table.api.formatter.datetime, operate: 'RANGE', addclass: 'datetimerange', sortable: true},
                        // {field: 'endtime', title: __('結束時間'), formatter: Table.api.formatter.datetime, operate: 'RANGE', addclass: 'datetimerange', sortable: true},
