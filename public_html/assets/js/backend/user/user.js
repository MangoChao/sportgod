    ...
    var Controller = {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'ptime1', title: __('區間開始'), formatter: Table.api.formatter.datetime, addclass: 'datetimerange', datetimeFormat: 'YYYY-MM-DD', sortable: true, visible: false},
                        {field: 'ptime2', title: __('區間結束'), formatter: Table.api.formatter.datetime, addclass: 'datetimerange', datetimeFormat: 'YYYY-MM-DD', sortable: true, visible: false},
                        {field: 'pred', title: __('預測限次'), operate: 'LIKE', visible: false},
                        {field: 'pred2', title: __('剩餘次數'), operate: 'LIKE', visible: false},
                        {field: 'line_user_id', title: __('LINE UID'), operate: 'LIKE', visible: false},
                        {field: 'service.nickname', title: __('客服'), operate: 'LIKE', visible: false},
                        {field: 'isgod', title: __('isgod'), formatter: Controller.api.formatter.isgod, searchList: {0: __('isgod 0'), 1: __('isgod 1')}},
        ...
        api: {
            ...
            formatter:{
                ...
                isgod: function (value, row, index, custom) {
                    var colorArr = {'0':'black','1':'orange'};
                    var valueArr = {'0':__('isgod 0'),'1':__('isgod 1')};
                    if (typeof custom !== 'undefined') {
                        colorArr = $.extend(colorArr, custom);
                    }
                    var color = typeof colorArr[value] !== 'undefined' ? colorArr[value] : 'orange';
